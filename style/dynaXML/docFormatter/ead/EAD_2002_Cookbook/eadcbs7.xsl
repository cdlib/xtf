...
a matching element with content in the finding aid.-->
		<xsl:if test="string(archdesc/did/head)">
			<p>
				<b>
					<a href="{$file}b.html#{generate-id(archdesc/did/head)}">
		...
		<xsl:if test="string(archdesc/bioghist/head)">
			<p style="margin-top:-5pt">
				<b>
					<a href="{$file}b.html#{generate-id(archdesc/bioghist/head)}">
		...
		<xsl:if test="string(archdesc/scopecontent/head)">
			<p style="margin-top:-5pt">
				<b>
					<a href="{$file}b.html#{generate-id(archdesc/scopecontent/head)}">
		...
		<xsl:if test="string(archdesc/arrangement/head)">
			<p style="margin-top:-5pt">
				<b>
					<a href="{$file}b.html#arrangementlink">
		...
		or string(archdesc/*/accessrestrict/head)">
			<p style="margin-top:-5pt">
				<b>
					<a href="{$file}b.html#restrictlink">
		...
		<xsl:if test="string(archdesc/controlaccess/head)">
			<p style="margin-top:-5pt">
				<b>
					<a href="{$file}b.html#{generate-id(archdesc/controlaccess/head)}">
		...
		or string(archdesc/*/separatedmaterial)">
			<p style="margin-top:-5pt">
				<b>
					<a href="{$file}b.html#relatedmatlink">
				...
				<b>
					<xsl:choose>
						<xsl:when test="archdesc/otherfindaid/head">
							<a href="{$file}b.html#{generate-id(archdesc/otherfindaid/head)}">
		...
		<xsl:if test="string(archdesc/odd/head)">
			<xsl:for-each select="archdesc/odd">
				<p style="margin-top:-5pt">
					<b>
						<a href="{$file}b.html#{generate-id(head)}">
				...
				<b>
					<xsl:choose>
						<xsl:when test="archdesc/bibliography/head">
							<a href="{$file}b.html#{generate-id(archdesc/bibliography/head)}">
				...
				<b>
					<xsl:choose>
						<xsl:when test="archdesc/index/head">
							<a href="{$file}b.html#{generate-id(archdesc/index/head)}">
		...
		<xsl:if test="string(archdesc/dsc/head)">
			<p style="margin-top:-5pt">
				<b>
					<a href="{$file}b.html#{generate-id(archdesc/dsc/head)}">
