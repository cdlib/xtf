...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	differs from that of the comparable container in the preceding
	component.-->
...
that are used genericly throughout the stylesheet.-->
...
for each level.-->
	...
	<xsl:template match="c08/did">
		...
		</xsl:choose>			<xsl:for-each select="abstract | note/p | langmaterial | materialspec">
				<tr>
					<td> </td>
					<td> </td>
					<td> </td>
