...
public class MoreLikeThis {
   ...
   * @see #setMinDocFreq   
     */
    public static final int DEFALT_MAX_DOC_FREQ = 0;
     ...
     */
    private int maxDocFreq = DEFALT_MAX_DOC_FREQ;
    ...
    /**
     * Returns the frequency at which words will be ignored which occur in at least this
     * many docs. The default frequency is {@link #DEFALT_MAX_DOC_FREQ}.
     *
     * @return the frequency at which words will be ignored which occur in at least this
     * many docs.
     */
    ...
    /**
     * Sets the frequency at which words will be ignored which occur in at least this
     * many docs.
     *
     * @param maxDocFreq the frequency at which words will be ignored which occur in at
     * least this many docs.
     */
