...
public abstract class Query implements java.io.Serializable, Cloneable {
  ...
  /** It can be very useful to iterate through the entire hierarchy of a
   *  Query without having to be intimately familiar with the structure
   *  of each kind of sub-query.
   */
  public Query[] getSubQueries() { return null; }
