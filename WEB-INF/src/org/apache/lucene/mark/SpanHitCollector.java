 ...
 *
 * @author  Martin Haye
 * @version $Id: SpanHitCollector.java,v 1.1 2005-02-08 23:19:38 mhaye Exp $
 * @see Searcher#search(Query,HitCollector)
 */
public abstract class SpanHitCollector extends HitCollector 
{
  ...
  /** Called if no spans found in query. */
