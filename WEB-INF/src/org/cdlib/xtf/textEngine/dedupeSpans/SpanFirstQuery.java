...
public class SpanFirstQuery extends SpanQuery {
      ...
      throws IOException 
  {
    return new Spans() {
        ...
        public float score() { return spans.score(); }
        public int coordBits() { return spans.coordBits(); }
        public Collection allTerms() { return spans.allTerms(); }
