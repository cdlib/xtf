...
/** The standard Lucene Weight interface, but for Spans */
class SpanWeight implements Weight {
                    ...
                    SpanHitCollector collector) 
  {
    ...
    TermMaskSet set = new TermMaskSet();
    for (Iterator i = terms.iterator(); i.hasNext();)
        set.add((Term)i.next());
    query.calcCoordBits(set);
  }
  ...
  {
    int maxCoord = 0;
    for( Iterator i = query.getTerms().iterator(); i.hasNext(); i.next() )
        maxCoord++;
