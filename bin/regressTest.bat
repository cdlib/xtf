:: Batch file to run the XTF regression tests on Windows
...
cd %XTF_HOME%\regress\CrossQuery
java -classpath "%XTFCP%" -Xms50m -Xmx500m -enableassertions org.cdlib.xtf.test.RegressTest %*
